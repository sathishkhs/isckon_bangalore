				...
				<div class="col-sm-10 col-md-10 mx-auto">
					<div class="inner-absolute-banner text-dark">
						...
						<div class="centralized-content ">
							<p class="text-center ">We appreciate your generosity and attempt to support the Lives. However, we regret to inform that your online donation transaction could not be completed due to possible technical error. </p>
						</div>
						<div class="centralized-content ">
							<p class="text-center ">Your contribution is of utmost significance. Hence, we request you to kindly try donating once again through this link <a class="btn btn-primary" href="<?php echo !empty($payment_data->page_slug) ? $payment_data->page_slug : 'donate-now'; ?>">Click Here</a></p>
