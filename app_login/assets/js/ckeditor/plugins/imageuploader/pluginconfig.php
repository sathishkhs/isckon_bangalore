...
$foldershistory[] = $useruploadfolder;
    $useruploadfolder = 'harekrishnamandir/uploads\\blog';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'harekrishnamandir/uploads\\blog';
    ...
    $useruploadfolder = 'igfwebdec/uploads/blog';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'igfwebdec/uploads/blog';
        

    $useruploadfolder = 'igfwebdec/uploads/ckeditor';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'igfwebdec/uploads/ckeditor';
        

    $useruploadfolder = 'igfwebdec/uploads/pages';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'igfwebdec/uploads/pages';
        

    $useruploadfolder = 'igfwebdec/uploads/page';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'igfwebdec/uploads/page';
        

    $useruploadfolder = 'igfwebdec/uploads/charitable_program';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'igfwebdec/uploads/charitable_program';
