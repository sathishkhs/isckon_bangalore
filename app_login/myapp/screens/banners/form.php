            ...
            <div class="card-body">
                ...
                <div class="row">
                   ...
                   <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="banner_heading" id="banner_heading" class="form-control" placeholder="Banner Heading" value="<?php echo (!empty($query->banner_heading)) ? $query->banner_heading : '' ?>">
                            </div>
                        </div>
                    </div>
                   <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                                <label for="banner_heading_2">Banner Heading 2</label>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="banner_heading_2" id="banner_heading_2" class="form-control" placeholder="Banner Heading 2" value="<?php echo (!empty($query->banner_heading_2)) ? $query->banner_heading_2 : '' ?>">
                            </div>
                        </div>
                    </div>
                   <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                <textarea type="text" name="banner_description" id="banner_description" class="form-control" placeholder="Banner Description" value=""><?php echo (!empty($query->banner_description)) ? $query->banner_description : '' ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <?php } ?>
                            <p class="image-dimention">Banner Image Size Should be 1550px width and 500px height.</p>
                        </div>
                    </div>
                </div>
