                            ...
                            <form class="form-horizontal" action="festivals/festival_save" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea name="schedule_content" id="schedule_content" rows="9" class="form-control summernote schedule_content" placeholder="Page Content" data-validation="required"><?php echo (!empty($query->schedule_content)) ? $query->schedule_content : '' ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="eror"><?php echo form_error('festival_description'); ?></span>
                                        <textarea name="festival_description" type="text" class="form-control summernote" value=""><?php echo (!empty($query->festival_description)) ? $query->festival_description : ''; ?>  </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-8 col-md-8 control-label" for="form-field-4">Make Featured Festival</label>
                                    <div class="col-sm-10">
