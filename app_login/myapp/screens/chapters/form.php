                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <form class="form-horizontal" action="chapters/chapter_save" method="post" enctype="multipart/form-data">
                                <input name="chapter_id" type="hidden" value="<?php echo (!empty($query->chapter_id)) ? $query->chapter_id : ''; ?>" />
                                <br />
                                <div class="form-group">
                                    <label class="col-sm-6 col-md-6 control-label" for="form-field-1">Chapter Title </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 col-md-6 control-label" for="form-field-3">Chapter Thumbnail Image</label>
                                    ...
                                    <?php if (!empty($query->banner)) { ?>
                                        <div class="col-sm-2">
                                            <img src="<?php echo CHAPTER_BANNER_PATH . $query->banner; ?>" width="80px" height="80px">
                                        </div>
                                    <?php } ?>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-6 col-md-6 control-label" for="form-field-3">Chapter Image</label>
                                    ...
                                    <?php if (!empty($query->banner_image)) { ?>
                                        <div class="col-sm-2">
                                            <img src="<?php echo CHAPTER_BANNER_PATH . $query->banner_image; ?>" width="80px" height="80px">
                                        </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 col-md-6 control-label" for="form-field-5">Short Description</label>
                                    <div class="col-sm-10">
                                        <span class="eror"><?php echo form_error('chapter_desc'); ?></span>
                                        <textarea name="short_chapter_desc" type="text" class="form-control  " value=""><?php echo (!empty($query->short_chapter_desc)) ? $query->short_chapter_desc : ''; ?>  </textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-6 col-md-6 control-label" for="form-field-5">Chapter Description</label>
                                    <div class="col-sm-10">
                                        <span class="eror"><?php echo form_error('chapter_desc'); ?></span>
                                        <textarea name="chapter_desc" type="text" class="form-control ckeditor /summernote" value=""><?php echo (!empty($query->chapter_desc)) ? $query->chapter_desc : ''; ?>  </textarea>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 col-md-6 control-label" for="form-field-1">Chapter Goal Amount </label>
                                    <div class="col-sm-10">
