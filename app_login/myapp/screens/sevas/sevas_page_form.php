                            ...
                            <form class="form-horizontal" action="sevas/sevas_page_save" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea name="seva_page_desc_top" type="text" class="form-control summernote" value=""><?php echo (!empty($query->seva_page_desc_top)) ? $query->seva_page_desc_top : ''; ?>  </textarea>
                                    </div>
                                </div>
