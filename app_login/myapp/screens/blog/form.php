	            ...
	            <div class="card-body">
	                ...
	                <div class="row">
	                    ...
	                    <div class="col-xs-8 col-sm-8 col-md-8">
	                        <div class="form-group">
	                            <textarea name="post_content" id="post_content" class="form-control ckeditor ckeditor /summernote" placeholder="Post Content" data-validation="required"><?php echo (!empty($query->post_content)) ? $query->post_content : '' ?></textarea>
	                        </div>
	                    </div>
	                </div>
