	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form class="form-horizontal" action="adminusers/save" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="col-sm-10 col-md-8 control-label" for="form-field-3">Mobile Number<span class="eror"><?php echo form_error('phone_number'); ?></span></label>
					<div class="col-sm-10">
						<input name="phone_number" type="text" class="form-control" value="<?php echo (!empty($query->phone_number)) ? $query->phone_number : ''; ?>"  pattern="[1-9]{1}[0-9]{9}" title="Enter correct Mobile number" required/>
					</div>
				</div>
				<!-- <div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-10 col-md-8 control-label" for="form-field-7">Confirm Password<span class="eror"><?php echo form_error('confirm_password'); ?></span></label>
					<div class="col-sm-10">
